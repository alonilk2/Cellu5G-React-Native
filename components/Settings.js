...
import { StyleSheet, View, Text, Image ,Switch, Pressable, ScrollView } from 'react-native';
    ...
    return (
        <Animation style={styles.settings}>
            ...
            <View style={{justifyContent:'center', flexDirection: 'row', marginBottom: 15}}>
                ...
                />
                <Text style={styles.SettingsText}> {Global.radius} </Text>
            </View>
            ...
            <View style={{flexDirection: 'row', justifyContent: 'center', flex: 3}}>
                <View style={{margin: 10, marginTop: 0}}>
                    <Text style={{fontFamily: "SF-Pro-Text-Bold", fontSize: 25, fontWeight: 'bold'}}> 3G </Text>
                    <Switch
                    trackColor={{ false: "#767577", true: "#81b0ff" }}
                    thumbColor={Global.g3Toggle ? "#00bd19" : "#a6a6a6"}
                    ios_backgroundColor="#3e3e3e"
                    value={Global.g3Toggle}
                    onValueChange={Global.g3Toggle ? () => {
                ...
                <View style={{margin: 10, marginTop: 0}}>
                    <Text style={{fontFamily: "SF-Pro-Text-Bold", fontSize: 25, fontWeight: 'bold'}}> 4G </Text>
                    <Switch
                    trackColor={{ false: "#767577", true: "#81b0ff" }}
                    thumbColor={Global.g4Toggle ? "#00bd19" : "#a6a6a6"}
                    ios_backgroundColor="#3e3e3e"
                    value={Global.g4Toggle}
                    onValueChange={Global.g4Toggle ? () => {
                ...
                <View style={{margin: 10, marginTop: 0}}>
                    <Text style={{fontFamily: "SF-Pro-Text-Bold", fontSize: 25, fontWeight: 'bold'}}> 5G </Text>
                    <Switch
                    trackColor={{ false: "#767577", true: "#81b0ff" }}
                    thumbColor={Global.g5Toggle ? "#00bd19" : "#a6a6a6"}
                    ios_backgroundColor="#3e3e3e"
                    value={Global.g5Toggle}
                    onValueChange={Global.g5Toggle ? () => {
